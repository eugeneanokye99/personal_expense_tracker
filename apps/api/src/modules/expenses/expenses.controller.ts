...
export class ExpensesController {
  static async list(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const result = await ExpensesService.list(req.supabase, req.user!.id, {
  ...
  static async create(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const expense = await ExpensesService.create(req.supabase, req.user!.id, { amount: parseFloat(amount), category, merchant, note, date, transactionType, source, channel });
  ...
  static async getOne(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const expense = await ExpensesService.getOne(req.supabase, req.user!.id, req.params.id);
  ...
  static async update(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const expense = await ExpensesService.update(req.supabase, req.user!.id, req.params.id, updates);
      res.json({ success: true, data: expense });
    } catch (err) { next(err); }
  }
  ...
  static async remove(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      await ExpensesService.remove(req.supabase, req.user!.id, req.params.id);
  ...
  static async getMerchants(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const merchants = await ExpensesService.getDistinctMerchants(req.supabase, req.user!.id);
  ...
  static async exportCsv(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const csv = await ExpensesService.exportCsv(req.supabase, req.user!.id, { from, to });
  ...
  static async getSummary(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { from, to } = req.query as Record<string, string>;
      const summary = await ExpensesService.getSummary(req.supabase, req.user!.id, { from, to });
